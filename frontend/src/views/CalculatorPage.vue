<template>
  <div class="calculator-page">
    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="单Build计算" name="single">
        <el-form :model="form" label-width="100px" style="max-width: 600px">
          ...
          <el-form-item label="物理伤害">
            <el-col :span="11">
              <el-input-number v-model="form.weapon.physMin" placeholder="最小值" :min="0" controls-position="right" />
            </el-col>
            <el-col :span="2" style="text-align: center">-</el-col>
            <el-col :span="11">
              <el-input-number v-model="form.weapon.physMax" placeholder="最大值" :min="0" controls-position="right" />
            </el-col>
          </el-form-item>
        ...
        <el-descriptions v-if="result" title="计算结果" :column="2" border style="margin-top: 20px; max-width: 600px">
      ...
      <el-tab-pane label="Build对比" name="compare">Build对比功能开发中...</el-tab-pane>
    </el-tabs>
  </div>
</template>
